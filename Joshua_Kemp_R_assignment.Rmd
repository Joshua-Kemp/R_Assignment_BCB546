...
##my machine runs out of memory running this ggplot(data = contaminated_lines) + geom_point(mapping = aes(x= Sample_ID, y= Mean_Homozygosity, color = Species)) ##Many of these lines are less inbred than I would expect, not sure if hybrids or complex lines were included on purpose. Depends on the type of study this was for.
...
#install.packages("tidyverse", "dplyr", "sjmisc") #install.packages("sjmisc")
